...
<title>March Pictures - LevsDelight</title>
<meta name="keywords" content="march pictures villa rica farm" />
		...
		<div id="page-bgcontent">
				...
				<div id="thumbs" class="navigation">
					<ul class="thumbs noscript">
						...
						<?php
							...
							$pictureShowQuery = "SELECT * FROM slideshows WHERE slideshowid = 4 and isActive = 1 ";
			...
			<!-- end #content -->			
				...
				<?php							 
					...
					$pictureShowQueryTwo = "SELECT * FROM slideshows WHERE slideshowid = 4 ";
