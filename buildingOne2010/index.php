...
<title>Building a Building Pictures - LevsDelight</title>
<meta name="keywords" content="Building a Buildingpictures villa rica farm" />
		...
		<div id="page-bgcontent">
				...
				<div id="thumbs" class="navigation">
					<ul class="thumbs noscript">
						...
						<?php
							...
							$pictureShowQuery = "SELECT * FROM slideshows WHERE slideshowid = 8 and isActive = 1 ";
			...
			<!-- end #content -->			
				...
				<?php							 
					...
					//***************************CHANGE SLIDESHOWID HERE TO REFLECT THIS SLIDESHOW************************
					$pictureShowQueryTwo = "SELECT * FROM slideshows WHERE slideshowid = 8 ";
