...
<title>Chicken Coop One Pictures - LevsDelight</title>
<meta name="keywords" content="Chicken Coop One pictures villa rica farm" />
		...
		<div id="page-bgcontent">
				...
				<div id="thumbs" class="navigation">
					<ul class="thumbs noscript">
						...
						<?php
							...
							$pictureShowQuery = "SELECT * FROM slideshows WHERE slideshowid = 9 and isActive = 1 ";
			...
			<!-- end #content -->			
				...
				<?php							 
					...
					//***************************CHANGE SLIDESHOWID HERE TO REFLECT THIS SLIDESHOW************************
					$pictureShowQueryTwo = "SELECT * FROM slideshows WHERE slideshowid = 9 ";
