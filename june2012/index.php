...
<title>June Pictures - LevsDelight</title>
<meta name="keywords" content="June pictures villa rica farm" />
	...
	<div id="header-wrapper">
		...
		<div id="menu">
			...
			<ul>
				...
				<li><a href="http://www.levsdelight.com/june2012">June Pictures</a></li>
		...
		<div id="page-bgcontent">
				...
				<div id="thumbs" class="navigation">
					<ul class="thumbs noscript">
						...
						<?php
							...
							$pictureShowQuery = "SELECT * FROM slideshows WHERE slideshowid = 7 and isActive = 1 ";
			...
			<!-- end #content -->			
				...
				<?php							 
					...
					//***************************CHANGE SLIDESHOWID HERE TO REFLECT THIS SLIDESHOW************************
					$pictureShowQueryTwo = "SELECT * FROM slideshows WHERE slideshowid = 7 ";
