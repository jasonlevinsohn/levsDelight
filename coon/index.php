...
//**********************************************************************************************
$slideshowId = "13"; //This is the id number for this slideshow.  Each one must be unique.  Also used to upload images
$folderName = "coon"; //Used for image upload.  Must be the folder name of the slideshow
$title = "Racoon Pictures";
...
<title><?php echo $title; ?> - LevsDelight</title>
<meta name="keywords" content="July pictures villa rica farm" />
	...
	<div id="header-wrapper">
		...
		<script type="text/javascript">
			jQuery(document).ready(function($) {
				$('#menu').load('../navigation-block.html');
			});
		</script>
		<!-- end #menu -->
	</div>
