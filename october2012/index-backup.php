...
<title>July Pictures - LevsDelight</title>
	...
	<div id="header-wrapper">
		...
		<div id="menu">
			...
			<ul>
				...
				<li><a href="http://www.levsdelight.com/july2012">July Pictures</a></li>
		...
		<div id="page-bgcontent">
				...
				<div id="thumbs" class="navigation">
					<ul class="thumbs noscript">
						...
						<?php
							...
							$pictureShowQuery = "SELECT * FROM slideshows WHERE slideshowid = 12 and isActive = 1 ";
			...
			<!-- end #content -->			
				...
				<?php							 
					...
					//***************************CHANGE SLIDESHOWID HERE TO REFLECT THIS SLIDESHOW************************
					$pictureShowQueryTwo = "SELECT * FROM slideshows WHERE slideshowid = 12 ";
