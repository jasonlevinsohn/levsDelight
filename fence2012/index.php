...
<title>The Big Two Acre Fence Pictures - LevsDelight</title>
<meta name="keywords" content="The Big Two Acre Fence pictures villa rica farm" />
	...
	<div id="header-wrapper">
		...
		<div id="menu">
			...
			<ul>
				...
				<li><a href="http://www.levsdelight.com/buildingOne2010">Building One Project</a></li>
				<li><a href="http://www.levsdelight.com/coopOne2012">Coop One</a></li>
				<li><a href="http://www.levsdelight.com/coopTwo2012">Coop Two</a></li>
				<li><a href="http://www.levsdelight.com/fence2012">Building a Fence</a></li>
		...
		<div id="page-bgcontent">
				...
				<div id="thumbs" class="navigation">
					<ul class="thumbs noscript">
						...
						<?php
							...
							$pictureShowQuery = "SELECT * FROM slideshows WHERE slideshowid = 11 and isActive = 1 ";
			...
			<!-- end #content -->			
				...
				<?php if(isset($_SESSION['SESS_MEMBER_ID']) && isset($_SESSION['SESS_FIRST_NAME'])) { ?>
					...
					<button name="uploadFiles" id="uploadFiles" onClick="javascript:ajaxLoader();">Upload Files</button>
					<script>
						var reader;
						window.files = [];
						window.imagePath = [];
				...
				<?php							 
					...
					//***************************CHANGE SLIDESHOWID HERE TO REFLECT THIS SLIDESHOW************************
					$pictureShowQueryTwo = "SELECT * FROM slideshows WHERE slideshowid = 11 ";
