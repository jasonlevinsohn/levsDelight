...
<title>May Pictures - LevsDelight</title>
<meta name="keywords" content="May pictures villa rica farm" />
	...
	<div id="header-wrapper">
		...
		<div id="menu">
			...
			<ul>
				...
				<li><a href="http://www.levsdelight.com/march2012">March Pictures</a></li>
				<li><a href="http://www.levsdelight.com/april2012">April Pictures</a></li>
				<li><a href="http://www.levsdelight.com/may2012">May Pictures</a></li>
		...
		<div id="page-bgcontent">
				...
				<div id="thumbs" class="navigation">
					<ul class="thumbs noscript">
						...
						<?php
							...
							$pictureShowQuery = "SELECT * FROM slideshows WHERE slideshowid = 6 and isActive = 1 ";
			...
			<!-- end #content -->			
				...
				<?php							 
					...
					//$pictureShowQueryTwo = "SELECT * FROM slideshows WHERE slideshowid = 2 and isActive = 1 ";
					
					//***************************CHANGE SLIDESHOWID HERE TO REFLECT THIS SLIDESHOW************************
					$pictureShowQueryTwo = "SELECT * FROM slideshows WHERE slideshowid = 6 ";
