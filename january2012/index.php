...
<meta name="keywords" content="january pictures villa rica farm" />
				...
				<div id="thumbs" class="navigation">
					<ul class="thumbs noscript">
						...
						<?php
							...
							$pictureShowQuery = "SELECT * FROM slideshows WHERE slideshowid = 2 and isActive = 1 ";
...
<!-- If we are logged in, we can change the description, otherwise no. -->
				<?php if(isset($_SESSION['SESS_MEMBER_ID']) && isset($_SESSION['SESS_FIRST_NAME'])) { 
					...
					$pictureShowQueryTwo = "SELECT * FROM slideshows WHERE slideshowid = 2 ";
