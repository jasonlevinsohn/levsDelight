			...
			<div id="content">
				...
				<div id="thumbs" class="navigation">
					<ul class="thumbs noscript">
						...
						<li>
							<a class="thumb" name="leaf" href="images/main/chicks-338-m.jpg" title="The Chicks">
								<img src="images/thumbs/chicks-338-t.jpg" alt="The Chicks" />
							</a>
							<div class="caption">
								<div class="download">
									<a href="images/main/chicks-338-m.jpg">Download Original</a>
								</div>
